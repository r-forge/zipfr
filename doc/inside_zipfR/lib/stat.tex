...
%% \IV{f_i = M};  \bigIV{\sum_{i=1}^S f_i = N}
%% indicator variable (as in Baayen 2001), and variant with explicitly scaled brackets
\newcommand{\IV}[1]{I_{\left[#1\right]}}
\newcommand{\bigIV}[1]{I_{\bigl[#1\bigr]}}
...
%% \binomP{k}{n}{p}
%% binomial probability of k successes out of n trials with probability p
\newcommand{\binomP}[3]{B\bigl(#1; #2, #3\bigr)}
